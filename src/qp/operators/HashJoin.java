...
public class HashJoin extends Join {
	...
	public boolean open() {
		...
		/**
		 * The first hash fn is a prime number to distrbute the relation equally
	...
	public Batch next() {
		 ...
		 * into buckets and add them to hashmap using initial hash function
		 **/
		if (eosl == false) {
