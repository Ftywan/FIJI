...
public class SortMergeJoin_Original extends Join {
	 ...
	 */
	public SortMergeJoin_Original(Join jn) {
	...
	public Batch next() {
		...
		while (!outBatch.isFull()) {
			...
			System.out.println("SMJ: What are left and right tuples");
			Debug.PPrint(leftTuple);
			Debug.PPrint(rightTuple);
			if (comparisionResult == 0) {
				System.out.println("SMJ: compare result = 0");
				...
				System.out.print("Compare Result is ");
				...
				System.out.print("Compare Reusult is ?");
				System.out.println(comparisionResult);
				rightPartition = createNextRightPartition();
				if (rightPartition.isEmpty()) {
					eosRight = true;
